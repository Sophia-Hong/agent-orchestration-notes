# agent-orchestration-notes (English)
...
- [`ORCHESTRATOR_HARNESS_GUIDE.md`](ORCHESTRATOR_HARNESS_GUIDE.md) — Architecture reference. System prompt structure, coordinator design, agent definitions, quality systems, and complete template library.
...
| `/verify` | [skills/verify.md](skills/verify.md) | Independent verification agent — gate on PASS |
| `/handoff` | [skills/handoff.md](skills/handoff.md) | Review a worker prompt before sending |

## Background

Reverse-engineered from the Claude Code source snapshot (leaked 2026-03-31).
See [`skills/README.md`](skills/README.md) for full context.
